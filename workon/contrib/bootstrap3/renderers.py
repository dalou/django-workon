    ...
    def render_errors(self):
        ...
        if formset_errors:
            return render_template_to_unicode(
                'workon/bootstrap3/form_errors.html',
                context={
...
class FieldRenderer(BaseRenderer):
    ...
    def __init__(self, field, *args, **kwargs):
        if not isinstance(field, BoundField):
            raise BootstrapError('Parameter "field" should contain a valid Django BoundField. "%s" is invalid' % field)
        self.field = field
    ...
    def append_to_field(self, html):
        ...
        if help_text_and_errors:
            help_html = render_template_to_unicode(
                'workon/bootstrap3/field_help_text_and_errors.html',
                context={
                    'field': self.field,
