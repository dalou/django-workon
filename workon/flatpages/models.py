...
from workon.fields import HTMLField
# from taggit_autosuggest.managers import TaggableManager as AutosuggestTaggableManager


class FlatPagePosition(models.Model):

    flatpage = models.ForeignKey("workon.FlatPage", verbose_name="Page statique", related_name="positions")
...
class FlatPage(models.Model):
    ...
    # tags = AutosuggestTaggableManager(verbose_name="Tags", help_text=u"Séparez par une virgule ou utilisez la touche tabulation.", related_name="WORKON_flatpages", blank=True)
