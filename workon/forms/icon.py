...
class IconInput(forms.widgets.TextInput):
    ...
    def render(self, name, value, attrs=None):
        ...
        html = """<style>
            ...
            .workon-icon-widget:hover {
                text-decoration: none; color:rgb(30, 31, 102);   display: inline-block;
                transition: all 0.4s ease-out;
            }
            .workon-icon-widget.active,
            .workon-icon-widget.active i,
            .workon-icon-widget.active a,
            .workon-icon-widget.active span {
                color:green; font-size: 25px; font-weight: bold;
            }

        </style>
        <div id="icons-%s">
            <div style="" class="workon-icon-widget-tabs">""" % id
        ...
        for title, local_path, path, classname, prefix in self.styles:
            ...
            tabs += """<li><a class="workon-icon-widget-tabs-control" href="#tab-%s-%s">%s</a></li>""" % (id, i, title)
            contents += """<div class="workon-icon-widget-tabs-content" id="tab-%s-%s" style="display:none;">"""  % (id, i)
            for item in re.finditer(
                ...
                contents += """<a class="workon-icon-widget %s" data-value="%s" data-input="#%s"><i class="%s"></i></a>""" % (
