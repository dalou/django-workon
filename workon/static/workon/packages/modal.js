...
window.workon_packages_modal = true;

$(document).ready(function(apply_packages_on_insert)
{

    apply_packages_on_insert = function(inserted)
    {
        ...
        $(document).trigger('workon.modal_after_insert', [inserted]);
    }

    $(document).on('mousedown', '[data-modal-confirm]', function(e, self)
    {
        e.preventDefault();
        self = $(this);
        $.magnificPopup.open(
        {
            ...
            callbacks: {
                open: function() {
                    self.trigger('workon.modal_opened', [])
